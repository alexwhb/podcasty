...
//  console.log('Submitted FormData:', Object.fromEntries(formData));
  ...
  if (actionType === 'delete') {
    ...
    return redirect(`/users/${podcast.owner.username}/podcasts/`);
  }
  ...
  const updatedPodcast = await prisma.podcast.upsert({
    ...
    update: {
      ...
      explicit,
      baseUrl,
      image: imageUpdate === null && existingPodcast?.image
  ...
  return redirect(`/users/${updatedPodcast.owner.username}/podcasts/${updatedPodcast.id}`);
}
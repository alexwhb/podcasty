...
const LoginFormSchema = z.object({
	...
	redirectTo: z.string().optional().default('/users/me/podcasts'),
...
function PasskeyLogin({
	...
	async function handlePasskeyLogin(event: React.FormEvent<HTMLFormElement>) {
		...
		try {
			...
			const optionsResponse = await fetch('/_auth/webauthn/authentication')
			...
			const verificationResponse = await fetch('/_auth/webauthn/authentication', {
				method: 'POST',
